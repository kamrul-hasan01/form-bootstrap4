...
if(isset($_POST['create'])){
    ...
    $query= "UPDATE user SET fname='$fname', sname='$sname',password= '$password',day='$day',month= '$month',year='$year',gender= '$gender',opinion= '$opinion',optional= '$optional' WHERE ID='$ID'"; 
    $data=mysqli_query($conn,$query); 

    // $sql ="INSERT INTO user (fname,sname,email, password,day,month,year,gender,opinion,optional) VALUES ('$fname','$sname','$email','$password','$day','$month','$year','$gender','$opinion','$optional') WHERE ID='$ID'";
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <input type="text" class="form-control"
                                                                    placeholder="First name" id="name" name="fname" value=<?php echo $fname ?> required>
                                                                <p id="n_error" class="text-left"></p>

                                                            </div>
                                                            <div class="col">
                                                                <input type="text" id="sname" name="sname" class="form-control"
                                                                    placeholder="Surname" value=<?php echo $sname ?>  required>
                                                        ...
                                                        <div class="text-left">
                                                            ...
                                                            <div class="form-row">
                                                                <div class="form-group col-md-4">
                                                                    ...
                                                                    <select id="day" name="day" value=<?php echo $day ?>   class="form-control" required>
                                                                ...
                                                                <div class="form-group col-md-4">
                                                                    ...
                                                                    <select id="month" name="month"value=<?php echo $month ?>  class="form-control" required>
                                                                        <option selected value=<?php echo $month ?> >Month</option>
                                                                ...
                                                                <div class="form-group col-md-4">
                                                                    <select id="year" name="year"value=<?php echo $year ?>  class="form-control" required>
                                                        ...
                                                        <div class="text-left">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="opinion" id=""
                                                                    required>
                                                                    <option class="text-muted" value=""value=<?php echo $opinion ?> >Select your
                                                                        opinion
                                                                    </option>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    placeholder="Gender Optional" name="optional" value=<?php echo $optional ?> >
                                                            </div>
